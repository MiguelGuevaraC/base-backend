...
class AuthenticationController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/base-backend/public/api/logout",
     *     tags={"Authentication"},
     *     summary="Logout",
    ...
    public function logout(): JsonResponse
    {
     ...
     /**
     * @OA\Post(
     *     path="/base-backend/public/api/login",
     *     summary="Login user",
     *     tags={"Authentication"},
     ...
     *             @OA\Property(property="username", type="string", example="adminbase"),
    ...
    /**
     * @OA\Get(
     *     path="/base-backend/public/api/authenticate",
